...
export const translations = {
  ...
  en: {
    ...
    visual: {
      ...
      inputItems: [
        { title: 'Device data', meta: 'Telemetry', detail: 'Connections, metrics, online state' },
        { title: 'Business events', meta: 'Event stream', detail: 'Alerts, tickets, workflow triggers' },
        { title: 'System state', meta: 'State sync', detail: 'Permissions, audit, progress' },
      ],
      coreLabel: 'Business capability hub',
      coreBody: 'Data flow · business flow',
      serviceLabel: 'Business collaboration modules',
      serviceCards: [
        { title: 'Business rules', meta: 'Rule automation', text: 'Turn events into workflows, notices and system actions', tone: 'a', status: 'Orchestrated' },
        { title: 'Business alerts', meta: 'Exception response', text: 'Sync alerts, handling progress and collaboration flows', tone: 'b', status: 'SLA synced' },
        { title: 'Dashboards', meta: 'Operational visibility', text: 'Unify device state, outcomes and operating trends', tone: 'c', status: 'Live refresh' },
      ],
