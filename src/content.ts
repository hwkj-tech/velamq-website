...
export const translations = {
  ...
  en: {
    ...
    visual: {
      ...
      inputLabel: 'Protocols',
      inputChips: ['MQTT', 'MQTT over QUIC', 'Open API'],
      inputItems: [
        { title: 'MQTT Access', meta: 'MQTT 3/5', detail: 'Connections, pub/sub' },
        { title: 'QUIC Link', meta: 'MQTT over QUIC', detail: 'Weak-network recovery' },
        { title: 'API & Webhook', meta: 'Open API', detail: 'Integration, callbacks' },
      ],
      coreLabel: 'Message and rule kernel',
      coreBody: 'Connect · route · rule',
      serviceLabel: 'Core technical capabilities',
      serviceCards: [
        { title: 'Rule Engine', meta: 'Rule Engine', text: 'Filter, transform, trigger', tone: 'a', status: 'SQL' },
        { title: 'Low-latency Route', meta: 'Realtime Route', text: 'Massive connection routing', tone: 'b', status: 'p95 ms' },
        { title: 'Observability', meta: 'Observability', text: 'Metrics, traces, audit', tone: 'c', status: 'Live' },
      ],
      modulesLabel: 'Technical feature modules',
      supportModules: ['Rule Engine', 'MQTT over QUIC', 'Low-latency Route', 'Open API'],
      flowLabel: 'Technical capability flow',
      flowSteps: ['MQTT', 'QUIC', 'VelaMQ', 'Rule Engine', 'API', 'Observability'],
    },
  },
} as const
