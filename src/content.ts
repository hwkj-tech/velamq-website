...
export const translations = {
  ...
  en: {
    ...
    visual: {
      ...
      serviceCards: [
        { title: 'SQL Rule Engine', meta: 'Stream Processing', text: '', tone: 'a' },
        { title: 'Low-latency Route', meta: 'Realtime Dispatch', text: '', tone: 'b' },
        { title: 'AI Ops Copilot', meta: 'Intelligent Ops', text: '', tone: 'c' },
        { title: 'ACL and Audit', meta: 'Security Governance', text: '', tone: 'a' },
        { title: 'Metrics and Alerting', meta: 'Live Observability', text: '', tone: 'b' },
      ],
