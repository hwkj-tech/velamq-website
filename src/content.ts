...
export const translations = {
  ...
  en: {
    ...
    visual: {
      ...
      serviceCards: [
        { title: 'SQL Rule Engine', meta: 'Stream Processing', text: '', tone: 'a', status: 'SQL' },
        { title: 'Low-latency Route', meta: 'Realtime Dispatch', text: '', tone: 'b', status: 'p95 ms' },
        { title: 'Observe & Secure', meta: 'Metrics Audit', text: '', tone: 'c', status: 'Live' },
      ],
