// Generated by scripts/import-fluxmq-docs.mjs from /Users/lulu/Work/fluxmq-rs-doc
...
export const fluxmqDocs: Record<'zh' | 'en', FluxMQDocsCatalog> = {
  "zh": {
    "locale": "zh",
    "productName": "FluxMQ",
    "title": "FluxMQ 文档中心",
    "eyebrow": "FluxMQ Docs",
    "body": "从 fluxmq-rs-doc 迁移而来的 FluxMQ 产品、安装、功能、API、规则引擎、数据源和运维手册，官网统一以 1.0 版本维护。",
    "searchPlaceholder": "浏览 FluxMQ 文档、规则、API",
    "sidebarLabel": "FluxMQ 文档目录",
    "tocLabel": "本页内容",
    "versionLabel": "文档版本",
    ...
    "versions": [
      {
        ...
        "status": "latest",
        "date": "FluxMQ 1.0",
        "note": "当前官网文档版本，内容来源于 fluxmq-rs-doc，并按官网文档系统重新排版。",
    ...
    "documents": {
      "FAQ": {
        "id": "FAQ",
        "title": "FAQ",
        "summary": "FluxMQ 3.0 把 MQTT 监听端点放到控制台管理，并随管理数据持久化。这样可以在不改启动配置的情况下新增、停用或调整 TCP、WebSocket、TLS 端点。",
        "sourcePath": "FAQ.md",
        "headings": [
          {
        ...
        "blocks": [
          ...
          {
            "type": "paragraph",
            "text": "FluxMQ 3.0 把 MQTT 监听端点放到控制台管理，并随管理数据持久化。这样可以在不改启动配置的情况下新增、停用或调整 TCP、WebSocket、TLS 端点。"
          },
          {
            "type": "heading",
            "id": "现在还需要-sqlitepostgresql-或-mysql-做管理库吗",
          ...
          {
            "type": "paragraph",
            "text": "不需要作为 FluxMQ 3.0 的 Broker 管理库。当前运行态和管理配置以本地 RocksDB 为状态机，集群复制通过 Storage Raft 完成。PostgreSQL、MySQL、SQLite 仍可作为规则动作或认证 SQL 数据源使用。"
          },
          {
            "type": "heading",
            "id": "控制台登录是否可以关闭",
          ...
          },
          {
            "type": "code",
            "language": "bash",
            "code": "cd /Users/lulu/Work/fluxmq-rs-doc\nnpm run capture:demo"
          },
          {
            "type": "paragraph",
      ...
      "api/prometheus": {
        "id": "api/prometheus",
        "title": "Prometheus 指标",
        "summary": "FluxMQ 3.0 暴露 Prometheus 文本指标：",
        ...
        "blocks": [
          {
            "type": "paragraph",
            "text": "FluxMQ 3.0 暴露 Prometheus 文本指标："
          },
          {
            "type": "code",
            "language": "text",
          ...
          {
            "type": "paragraph",
            "text": "集群部署时建议抓取每一个 FluxMQ 节点。指标里包含稳定的 `node_id` 标签，Grafana 可按节点过滤或聚合。"
          },
          {
            "type": "heading",
            "id": "主要指标族",
          ...
          },
          {
            ...
            "rows": [
              ...
              [
                "`fluxmq_mqtt_connections_total`",
                "MQTT 连接生命周期结果。"
              ],
              [
                "`fluxmq_mqtt_packets_total`",
                "按 listener、transport、protocol、direction、packet type 统计报文。"
              ],
              [
                "`fluxmq_mqtt_publish_total`",
                "发布计数，包含 direction、QoS、retain 标签。"
              ],
              [
                "`fluxmq_mqtt_drop_total`",
          ...
          },
          {
            ...
            "ordered": false,
            "items": [
              "`monitoring/grafana/fluxmq-overview.json`",
              "`monitoring/prometheus/fluxmq-alerts.yml`"
            ]
          },
          {
            "type": "paragraph",
      ...
      "guide/auth-acl": {
        ...
        "blocks": [
          ...
          {
            "type": "image",
            "alt": "FluxMQ 3.0 设备认证页面截图",
            "src": "/fluxmq-docs/img/screenshots/auth.png"
          },
          {
            "type": "paragraph",
            "text": "认证提供方的公共字段如下："
          ...
          {
            "type": "image",
            "alt": "FluxMQ 3.0 访问控制页面截图",
            "src": "/fluxmq-docs/img/screenshots/acl.png"
          },
          {
            "type": "paragraph",
      ...
      "guide/certificates": {
        ...
        "blocks": [
          ...
          {
            "type": "image",
            "alt": "FluxMQ 3.0 证书管理页面截图",
            "src": "/fluxmq-docs/img/screenshots/certificates.png"
          },
          {
            "type": "heading",
            "id": "服务端证书",
      ...
      "guide/cluster": {
        "id": "guide/cluster",
        "title": "集群",
        "summary": "FluxMQ 3.0 集群用于多节点订阅同步、远程投递、统一管理视图、Storage Raft 复制和 shard 副本查询。",
        ...
        "blocks": [
          {
            "type": "paragraph",
            "text": "FluxMQ 3.0 集群用于多节点订阅同步、远程投递、统一管理视图、Storage Raft 复制和 shard 副本查询。"
          },
          {
            "type": "image",
            "alt": "FluxMQ 3.0 集群概览所在仪表盘截图",
            "src": "/fluxmq-docs/img/screenshots/dashboard.png"
          },
          {
            "type": "heading",
            "id": "前置条件",
      ...
      "guide/commands": {
        ...
        "blocks": [
          ...
          {
            "type": "image",
            "alt": "FluxMQ 3.0 指令消费页面截图",
            "src": "/fluxmq-docs/img/screenshots/commands.png"
          },
          {
            "type": "heading",
            "id": "支持类型",
      ...
      "guide/console-security": {
        ...
        "blocks": [
          ...
          {
            "type": "image",
            "alt": "FluxMQ 3.0 控制台用户页面截图",
            "src": "/fluxmq-docs/img/screenshots/users.png"
          },
          {
            "type": "table",
            "headers": [
          ...
          },
          {
            "type": "code",
            "language": "bash",
            "code": "FLUXMQ_CONSOLE_BOOTSTRAP_PASSWORD='change-me' \\\nFLUXMQ_CONFIG_FILE=config.toml \\\n./fluxmqd"
          },
          {
            "type": "paragraph",
          ...
          {
            "type": "image",
            "alt": "FluxMQ 3.0 操作审计页面截图",
            "src": "/fluxmq-docs/img/screenshots/audit.png"
          },
          {
            "type": "paragraph",
            "text": "管理 API 会记录："
      ...
      "guide/datasources/http": {
        ...
        "blocks": [
          {
            "type": "image",
            "alt": "FluxMQ 3.0 数据源页面截图",
            "src": "/fluxmq-docs/img/screenshots/datasources.png"
          },
          {
            "type": "paragraph",
          ...
          },
          {
            ...
            "rows": [
              [
                "`url`",
                "`https://alarm.example.com/hooks/fluxmq`",
                "请求地址。"
              ],
              [
                "`method`",
          ...
          {
            "type": "image",
            "alt": "FluxMQ 3.0 数据源配置示例截图",
            "src": "/fluxmq-docs/img/screenshots/datasources.png"
          },
          {
            "type": "code",
            "language": "json",
            "code": "{\n  \"name\": \"alarm-webhook\",\n  \"source\": \"WEBHOOK\",\n  \"source_type\": {\n    \"Http\": {\n      \"url\": \"https://alarm.example.com/hooks/fluxmq\",\n      \"method\": \"POST\",\n      \"headers\": [\n        { \"name\": \"Content-Type\", \"value\": \"application/json\" },\n        { \"name\": \"X-Source\", \"value\": \"fluxmq-rs\" }\n      ],\n      \"timeout_ms\": 3000,\n      \"connect_timeout_ms\": 1000,\n      \"verify_tls\": true\n    }\n  }\n}"
          },
          {
            "type": "heading",
            "id": "webhook-动作示例",
      ...
      "guide/datasources/object-search-loki": {
        "id": "guide/datasources/object-search-loki",
        "title": "对象存储、搜索与 Loki",
        "summary": "FluxMQ 3.0 支持把规则命中的消息写入 S3 兼容对象存储、Elasticsearch、OpenSearch 和 Grafana Loki。这类数据源适合归档、检索和日志流场景。",
        ...
        "blocks": [
          {
            "type": "paragraph",
            "text": "FluxMQ 3.0 支持把规则命中的消息写入 S3 兼容对象存储、Elasticsearch、OpenSearch 和 Grafana Loki。这类数据源适合归档、检索和日志流场景。"
          },
          {
            "type": "image",
            "alt": "FluxMQ 3.0 数据源管理页面截图",
            "src": "/fluxmq-docs/img/screenshots/datasources.png"
          },
          {
            "type": "heading",
      ...
      "guide/datasources/overview": {
        "id": "guide/datasources/overview",
        "title": "数据源总览",
        "summary": "数据源是 FluxMQ 3.0 连接外部系统的统一抽象。认证 SQL、HTTP Webhook、规则动作、离线消息和指令链路都会复用数据源配置。",
        ...
        "blocks": [
          {
            "type": "paragraph",
            "text": "数据源是 FluxMQ 3.0 连接外部系统的统一抽象。认证 SQL、HTTP Webhook、规则动作、离线消息和指令链路都会复用数据源配置。"
          },
          {
            "type": "image",
            "alt": "FluxMQ 3.0 数据源页面截图",
          ...
          },
          {
            ...
            "rows": [
              ...
              [
                "`source`",
                "FluxMQ 规则源 key，例如 `POSTGRESQL`、`WEBHOOK`、`REDIS`、`KAFKA`、`LOG`。"
              ],
              [
                "`source_type`",
                "具体连接类型和参数。"
      ...
      "guide/datasources/sql-mysql": {
        ...
        "blocks": [
          ...
          },
          {
            "type": "code",
            "language": "json",
            "code": "{\n  \"name\": \"telemetry-mysql\",\n  \"source\": \"MYSQL\",\n  \"source_type\": {\n    \"Sql\": {\n      \"database_url\": \"mysql://fluxmq:secret@127.0.0.1:3306/iot\",\n      \"max_connections\": 16,\n      \"sql_dialect\": \"mysql\",\n      \"test_before_acquire\": true\n    }\n  }\n}"
          },
          {
            "type": "heading",
            "id": "表结构示例",
      ...
      "guide/datasources/sql-postgresql": {
        ...
        "blocks": [
          ...
          },
          {
            "type": "code",
            "language": "json",
            "code": "{\n  \"name\": \"telemetry-postgres\",\n  \"source\": \"POSTGRESQL\",\n  \"source_type\": {\n    \"Sql\": {\n      \"database_url\": \"postgres://fluxmq:secret@127.0.0.1:5432/iot\",\n      \"max_connections\": 16,\n      \"sql_dialect\": \"postgres\",\n      \"test_before_acquire\": true\n    }\n  }\n}"
          },
          {
            "type": "heading",
            "id": "遥测落库案例",
      ...
      "guide/endpoints": {
        "id": "guide/endpoints",
        "title": "监听端点",
        "summary": "监听端点决定 MQTT 客户端如何接入 Broker。FluxMQ 3.0 不从启动配置读取 MQTT 端口，而是通过控制台端点配置动态管理。",
        ...
        "blocks": [
          {
            "type": "paragraph",
            "text": "监听端点决定 MQTT 客户端如何接入 Broker。FluxMQ 3.0 不从启动配置读取 MQTT 端口，而是通过控制台端点配置动态管理。"
          },
          {
            "type": "image",
            "alt": "FluxMQ 3.0 监听端点页面截图",
            "src": "/fluxmq-docs/img/screenshots/endpoints.png"
          },
          {
            "type": "heading",
            "id": "端点字段",
      ...
      "guide/metrics-connections": {
        ...
        "blocks": [
          ...
          {
            "type": "image",
            "alt": "FluxMQ 3.0 连接管理页面截图",
            "src": "/fluxmq-docs/img/screenshots/connections.png"
          },
          {
            "type": "paragraph",
          ...
          {
            "type": "image",
            "alt": "FluxMQ 3.0 监控指标页面截图",
            "src": "/fluxmq-docs/img/screenshots/metrics.png"
          },
          {
            "type": "paragraph",
          ...
          {
            "type": "paragraph",
            "text": "外部 Grafana dashboard 见源码仓库 `monitoring/grafana/fluxmq-overview.json`。"
          }
        ]
      },
      "guide/rule-engine/actions": {
        ...
        "blocks": [
          {
            "type": "image",
            "alt": "FluxMQ 3.0 规则引擎页面截图",
            "src": "/fluxmq-docs/img/screenshots/rules.png"
          },
          {
            "type": "paragraph",
      ...
      "guide/rule-engine/functions": {
        ...
        "blocks": [
          ...
          {
            "type": "image",
            "alt": "FluxMQ 3.0 规则引擎和动态函数配置入口截图",
            "src": "/fluxmq-docs/img/screenshots/rules.png"
          },
          {
            "type": "heading",
      ...
      "guide/rule-engine/offline": {
        "id": "guide/rule-engine/offline",
        "title": "离线消息",
        "summary": "FluxMQ 3.0 的离线消息由规则引擎处理，不再由 Broker 内置 Redis/SQL 离线队列表或刷写线程负责。",
        ...
        "blocks": [
          ...
          {
            "type": "paragraph",
            "text": "FluxMQ 3.0 的离线消息由规则引擎处理，不再由 Broker 内置 Redis/SQL 离线队列表或刷写线程负责。"
          },
          {
            "type": "heading",
            "id": "设计思路",
      ...
      "guide/rule-engine/overview": {
        "id": "guide/rule-engine/overview",
        "title": "规则引擎总览",
        "summary": "规则引擎负责把 MQTT 消息和系统事件转换为外部动作，是 FluxMQ 3.0 的消息路由与数据集成核心。",
        ...
        "blocks": [
          {
            "type": "paragraph",
            "text": "规则引擎负责把 MQTT 消息和系统事件转换为外部动作，是 FluxMQ 3.0 的消息路由与数据集成核心。"
          },
          {
            "type": "image",
            "alt": "FluxMQ 3.0 规则引擎页面截图",
      ...
      "guide/rule-engine/reliability-outbox": {
        ...
        "blocks": [
          ...
          {
            "type": "image",
            "alt": "FluxMQ 3.0 规则引擎与 Outbox 管理页面截图",
            "src": "/fluxmq-docs/img/screenshots/rules.png"
          },
          {
            "type": "heading",
      ...
      "guide/use-cases": {
        ...
        "blocks": [
          ...
          {
            "type": "image",
            "alt": "FluxMQ 3.0 WebSocket 端点页面截图",
            "src": "/fluxmq-docs/img/screenshots/endpoints.png"
          },
          {
            "type": "paragraph",
          ...
          {
            "type": "image",
            "alt": "FluxMQ 3.0 规则引擎 Webhook 案例截图",
            "src": "/fluxmq-docs/img/screenshots/rules.png"
          },
          {
            "type": "paragraph",
          ...
          },
          {
            ...
            "items": [
              ...
              "URL 填 `https://alarm.example.com/hooks/fluxmq`。",
              "Method 选择 `POST`。",
          ...
          {
            "type": "paragraph",
            "text": "目标：业务系统写入 Kafka topic，FluxMQ 3.0 消费后下发到设备 MQTT topic。"
          },
          {
            "type": "paragraph",
            "text": "操作步骤："
          ...
          {
            "type": "image",
            "alt": "FluxMQ 3.0 仪表盘 License 页面截图",
            "src": "/fluxmq-docs/img/screenshots/dashboard.png"
          },
          {
            "type": "paragraph",
          ...
          },
          {
            ...
            "items": [
              "进入仪表盘，查看 License 面板。",
              "如果 `remaining_connections` 较低，准备新的 `fluxmq.lic`。",
              "点击顶部 License 图标。",
              "导入 License 文件。",
          ...
          {
            "type": "paragraph",
            "text": "目标：把 FluxMQ 3.0 指标接入外部监控系统并配置告警。"
          },
          {
            "type": "paragraph",
            "text": "Prometheus 配置："
          ...
          },
          {
            ...
            "items": [
              "启动 Prometheus。",
              "确认 targets 中 FluxMQ 为 up。",
              "Grafana 导入 `monitoring/grafana/fluxmq-overview.json`。",
              "Prometheus 加载 `monitoring/prometheus/fluxmq-alerts.yml`。",
          ...
          },
          {
            ...
            "ordered": false,
            "items": [
              "在 Prometheus Targets 页面确认 FluxMQ target 为 `UP`。",
      ...
      "index": {
        "id": "index",
        "title": "FluxMQ 3.0 文档中心",
        "summary": "FluxMQ 3.0 的产品说明、部署指南、控制台功能手册、API、监控运维与演示素材。",
        "sourcePath": "index.mdx",
        "headings": [
          {
            "id": "fluxmq-30-文档中心",
            "level": 1,
            "text": "FluxMQ 3.0 文档中心"
          },
          {
            "id": "快速入口",
            "level": 2,
        ...
        "blocks": [
          {
            "type": "paragraph",
            "text": "FluxMQ 3.0 的产品说明、部署指南、控制台功能手册、API、监控运维与演示素材。"
          },
          {
            "type": "paragraph",
            "text": "产品介绍"
      ...
      "install/config": {
        "id": "install/config",
        "title": "配置说明",
        "summary": "当前 FluxMQ 3.0 使用本地 RocksDB 作为 Broker 状态机，集群复制由 `[cluster]`、`[cluster.raft]` 和 `[cluster.shards]` 控制。MQTT 监听端点仍然通过控制台或管理 API 持久化，不写在启动配置里。",
        ...
        "blocks": [
          ...
          },
          {
            ...
            "ordered": true,
            "items": [
              "设置了 `FLUXMQ_CONFIG_FILE` 时，优先从指定 TOML 文件加载。",
              "未设置时，从环境变量加载。"
            ]
          },
          {
            "type": "paragraph",
            "text": "当前 FluxMQ 3.0 使用本地 RocksDB 作为 Broker 状态机，集群复制由 `[cluster]`、`[cluster.raft]` 和 `[cluster.shards]` 控制。MQTT 监听端点仍然通过控制台或管理 API 持久化，不写在启动配置里。"
          },
          {
            "type": "heading",
            "id": "核心配置",
      ...
      "install/package": {
        "id": "install/package",
        "title": "打包发布",
        "summary": "仓库内置 `deploy/package.sh`，会构建前端、编译 `fluxmqd`，并为目标平台生成 zip 包。",
        ...
        "blocks": [
          {
            "type": "paragraph",
            "text": "仓库内置 `deploy/package.sh`，会构建前端、编译 `fluxmqd`，并为目标平台生成 zip 包。"
          },
          {
            "type": "code",
            "language": "bash",
            "code": "cd /Users/lulu/Work/fluxmq-rs\nbash deploy/package.sh"
          },
          {
            "type": "heading",
            "id": "按操作系统选择运行包",
          ...
          },
          {
            "type": "code",
            "language": "text",
            "code": "dist/fluxmqd-{version}-{platform}.zip"
          },
          {
            "type": "paragraph",
          ...
          },
          {
            ...
            "rows": [
              [
                "Linux 服务器",
                "x86_64 / amd64",
                "`fluxmqd-{version}-linux-x86_64.zip`",
                "`start.sh`"
              ],
              [
                "Linux 服务器",
                "ARM64 / aarch64",
                "`fluxmqd-{version}-linux-aarch64.zip`",
                "`start.sh`"
              ],
              [
                "macOS Intel",
                "x86_64",
                "`fluxmqd-{version}-macos-x86_64.zip`",
                "`start.sh`"
              ],
              [
                "macOS Apple Silicon",
                "arm64 / aarch64",
                "`fluxmqd-{version}-macos-aarch64.zip`",
                "`start.sh`"
              ],
              [
                "Windows 服务器",
                "x86_64 / amd64",
                "`fluxmqd-{version}-windows-x86_64.zip`",
                "`start.bat`"
              ]
            ]
          },
          ...
          },
          {
            ...
            "items": [
              ...
              "Windows 包内二进制为 `bin/fluxmqd.exe`，其他平台为 `bin/fluxmqd`。",
          ...
          },
          {
            "type": "code",
            "language": "bash",
            "code": "unzip dist/fluxmqd-3.0.0-linux-x86_64.zip -d /opt/fluxmq\ncd /opt/fluxmq/fluxmqd-3.0.0-linux-x86_64\n./start.sh"
          },
          {
            "type": "paragraph",
          ...
          },
          {
            "type": "code",
            "language": "powershell",
            "code": "Expand-Archive .\\fluxmqd-3.0.0-windows-x86_64.zip -DestinationPath .\\fluxmq\ncd .\\fluxmq\\fluxmqd-3.0.0-windows-x86_64\n.\\start.bat"
          },
          {
            "type": "paragraph",
          ...
          },
          {
            ...
            "ordered": false,
            "items": [
              "macOS / Linux：`FLUXMQ_CONFIG_FILE=$PACKAGE_DIR/config.toml`",
              "Windows：`FLUXMQ_CONFIG_FILE=%PACKAGE_DIR%config.toml`"
            ]
          },
          {
            "type": "paragraph",
      ...
      "install/quick-start": {
        ...
        "blocks": [
          ...
          },
          {
            "type": "code",
            "language": "bash",
            "code": "cd /Users/lulu/Work/fluxmq-rs\nFLUXMQ_CONFIG_FILE=config.toml cargo run -p fluxmqd"
          },
          {
            "type": "paragraph",
          ...
          },
          {
            "type": "code",
            "language": "bash",
            "code": "FLUXMQ_CONFIG_FILE=config.toml cargo run -p fluxmqd --no-default-features"
          },
          {
            "type": "paragraph",
          ...
          },
          {
            "type": "code",
            "language": "bash",
            "code": "FLUXMQ_SKIP_WEB_BUILD=1 cargo build -p fluxmqd --no-default-features"
          },
          {
            "type": "paragraph",
            "text": "启动后，浏览器打开："
      ...
      "operations/monitoring": {
        ...
        "blocks": [
          ...
          },
          {
            "type": "code",
            "language": "toml",
            "code": "[logging]\nlevel = \"info\"\ndir = \"logs\"\ninfo_file = \"fluxmq-info.log\"\nerror_file = \"fluxmq-error.log\"\nmax_file_size_mb = 128\nmax_backup_files = 10"
          },
          {
            "type": "paragraph",
      ...
      "operations/storage": {
        "id": "operations/storage",
        "title": "存储与数据库",
        "summary": "FluxMQ 3.0 以本地 RocksDB 为 Broker 状态机。单机模式直接读写本地 RocksDB；集群模式通过 Storage Raft 复制元数据和管理配置，并通过 shard 副本承载 retained、session、delayed 等较大的 keyspace。",
        ...
        "blocks": [
          {
            "type": "paragraph",
            "text": "FluxMQ 3.0 以本地 RocksDB 为 Broker 状态机。单机模式直接读写本地 RocksDB；集群模式通过 Storage Raft 复制元数据和管理配置，并通过 shard 副本承载 retained、session、delayed 等较大的 keyspace。"
          },
          {
            "type": "image",
            "alt": "FluxMQ 3.0 Storage Raft 与存储概览页面截图",
            "src": "/fluxmq-docs/img/screenshots/dashboard.png"
          },
          {
            "type": "heading",
          ...
          },
          {
            ...
            "items": [
              ...
              "`fluxmq_storage_raft_forward_failures_total`、`commit_failures_total`、`snapshot_failures_total` 是否持续增长。",
              "`fluxmq_storage_backup_last_success_age_seconds` 是否超过备份策略要求。",
        ...
        "blocks": [
          ...
          },
          {
            ...
            "items": [
              ...
              "如果使用环境变量 `FLUXMQ_CONSOLE_BOOTSTRAP_PASSWORD`，默认用户名是 `admin`。"
            ]
          },
          {
            "type": "heading",
          ...
          },
          {
            ...
            "items": [
              ...
              "查看 `fluxmq-error.log` 中 vote、append、forward 相关错误。",
      ...
      "product/architecture": {
        "id": "product/architecture",
        "title": "系统架构",
        "summary": "FluxMQ 3.0 的核心路径可以分成五层：接入层、Broker 运行层、存储复制层、管理层和外部集成层。",
        ...
        "blocks": [
          {
            "type": "paragraph",
            "text": "FluxMQ 3.0 的核心路径可以分成五层：接入层、Broker 运行层、存储复制层、管理层和外部集成层。"
          },
          {
            "type": "heading",
            "id": "设计目标",
      ...
      "product/basic-info": {
        "id": "product/basic-info",
        "title": "基本信息",
        "summary": "FluxMQ 3.0 是基于 Rust 的 MQTT Broker 与管理控制台，面向设备接入、消息治理、规则转发和运维监控场景。",
        ...
        "blocks": [
          ...
          {
            "type": "paragraph",
            "text": "FluxMQ 3.0 是基于 Rust 的 MQTT Broker 与管理控制台，面向设备接入、消息治理、规则转发和运维监控场景。"
          },
          {
            "type": "paragraph",
          ...
          {
            "type": "paragraph",
            "text": "产品名称**FluxMQ 3.0** 实现语言**Rust 2024 edition** Web 控制台**React + Ant Design + Vite** 管理服务**Axum + 控制台静态资源** 集群存储**RocksDB + Storage Raft** 控制台认证**API 开启时强制 JWT 登录** Prometheus**`/-/metrics`**"
          },
          {
            "type": "heading",
            "id": "交付形态",
          ...
          {
            "type": "paragraph",
            "text": "包含 `fluxmqd`、`static/`、`config.toml` 和启动脚本。"
          },
          {
            "type": "heading",
            "id": "多平台-zip-包",
          ...
          {
            "type": "paragraph",
            "text": "**Linux x86_64**`fluxmqd-3.0.0-linux-x86_64.zip` **Linux ARM64**`fluxmqd-3.0.0-linux-aarch64.zip` **macOS Intel**`fluxmqd-3.0.0-macos-x86_64.zip` **macOS Apple Silicon**`fluxmqd-3.0.0-macos-aarch64.zip` **Windows x86_64**`fluxmqd-3.0.0-windows-x86_64.zip`"
          },
          {
            "type": "heading",
            "id": "目录速览",
          ...
          {
            "type": "paragraph",
            "text": "`apps/fluxmqd`主进程入口 `crates/broker`Broker 核心运行时 `crates/mqtt`MQTT 协议和监听器 `crates/api`控制台、认证、审计、指标 `crates/cluster`节点发现、同步和 fanout `crates/storage`RocksDB、Storage Raft、分片和备份 `crates/rule`规则引擎 `crates/assistant`控制台 AI 助手状态与模型接入 `crates/datasource`外部数据源 `web`管理控制台 `monitoring`Grafana 和 Prometheus 资产 `deploy`多平台打包脚本"
          },
          {
            "type": "heading",
            "id": "默认运行路径",
      ...
      "product/core-features": {
        ...
        "blocks": [
          ...
          {
            "type": "image",
            "alt": "FluxMQ 3.0 设备认证功能截图",
            "src": "/fluxmq-docs/img/screenshots/auth.png"
          },
          {
            "type": "image",
            "alt": "FluxMQ 3.0 访问控制功能截图",
            "src": "/fluxmq-docs/img/screenshots/acl.png"
          },
          {
            "type": "list",
          ...
          {
            "type": "image",
            "alt": "FluxMQ 3.0 数据源功能截图",
            "src": "/fluxmq-docs/img/screenshots/datasources.png"
          },
          {
            "type": "image",
            "alt": "FluxMQ 3.0 规则引擎功能截图",
            "src": "/fluxmq-docs/img/screenshots/rules.png"
          },
          {
            "type": "paragraph",
          ...
          {
            "type": "image",
            "alt": "FluxMQ 3.0 仪表盘功能截图",
            "src": "/fluxmq-docs/img/screenshots/dashboard.png"
          },
          {
            "type": "image",
            "alt": "FluxMQ 3.0 监控指标功能截图",
            "src": "/fluxmq-docs/img/screenshots/metrics.png"
          },
          {
            "type": "list",
      ...
      "product/demo": {
        "id": "product/demo",
        "title": "演示视频与截图",
        "summary": "本页素材由 `npm run capture:demo` 自动生成。脚本会启动一个临时 FluxMQ 3.0 实例，创建示例控制台数据，并采集控制台核心页面。",
        ...
        "blocks": [
          {
            "type": "paragraph",
            "text": "本页素材由 `npm run capture:demo` 自动生成。脚本会启动一个临时 FluxMQ 3.0 实例，创建示例控制台数据，并采集控制台核心页面。"
          },
          {
            "type": "heading",
            "id": "演示视频",
          ...
          {
            "type": "video",
            "src": "/fluxmq-docs/videos/fluxmq-rs-console-demo.webm",
            "title": "FluxMQ demo video"
          },
          {
            "type": "paragraph",
          ...
          },
          {
            ...
            "ordered": false,
            "items": [
              "FluxMQ 源码目录：`/Users/lulu/Work/fluxmq-rs`",
              "服务端二进制：`/Users/lulu/Work/fluxmq-rs/target/debug/fluxmqd`",
              "临时管理端口：`18080`",
              "临时 MQTT 端口：`18183`"
            ]
          },
          ...
          },
          {
            "type": "code",
            "language": "bash",
            "code": "FLUXMQ_RS_ROOT=/path/to/fluxmq-rs \\\nFLUXMQD_BIN=/path/to/fluxmqd \\\nFLUXMQ_DEMO_PORT=18080 \\\nnpm run capture:demo"
          }
        ]
      },
      ...
      "product/introduction": {
        ...
        "blocks": [
          ...
          {
            "type": "image",
            "alt": "FluxMQ 3.0 分层架构图",
            "src": "/fluxmq-docs/img/architecture/fluxmq-3-architecture.svg"
          },
          {
            "type": "heading",
            "id": "代码边界",
          ...
          {
            "type": "paragraph",
            "text": "`apps/fluxmqd` 启动进程，编排 `crates/mqtt`、`crates/broker` 和监听器生命周期。"
          },
          {
            "type": "heading",
            "id": "管理与安全",
      ...
      "product/license": {
        "id": "product/license",
        "title": "License 与授权",
        "summary": "FluxMQ 3.0 同时包含开源仓库 License 和运行时产品授权两层概念。",
        ...
        "blocks": [
          {
            "type": "paragraph",
            "text": "FluxMQ 3.0 同时包含开源仓库 License 和运行时产品授权两层概念。"
          },
          {
            "type": "image",
            "alt": "FluxMQ 3.0 License 面板所在仪表盘截图",
            "src": "/fluxmq-docs/img/screenshots/dashboard.png"
          },
          {
            "type": "heading",
          ...
          },
          {
            "type": "code",
            "language": "bash",
            "code": "FLUXMQ_LICENSE_FILE=/etc/fluxmq/fluxmq.lic ./fluxmqd"
          },
          {
            "type": "heading",
            "id": "未配置-license-时",
      ...
      "product/versioning": {
        "id": "product/versioning",
        "title": "版本管理",
        "summary": "FluxMQ 3.0 文档站使用 Docusaurus 官方文档版本机制管理版本。当前默认版本为 `3.0.0`，页面右上角的版本下拉显示具体版本号，后续发布新版本后可在不同版本之间切换。",
        ...
        "blocks": [
          {
            "type": "paragraph",
            "text": "FluxMQ 3.0 文档站使用 Docusaurus 官方文档版本机制管理版本。当前默认版本为 `3.0.0`，页面右上角的版本下拉显示具体版本号，后续发布新版本后可在不同版本之间切换。"
          },
          {
            "type": "list",
            "ordered": false,
          ...
          {
            "type": "paragraph",
            "text": "当 FluxMQ 3.0 发布新版本，例如 `3.1.0`，先确认 `docs/` 已经更新到该版本对应内容，然后执行："
          },
          {
            "type": "code",
            "language": "bash",
  ...
  "en": {
    ...
    "eyebrow": "FluxMQ Docs",
    "body": "FluxMQ product, installation, feature, API, rule engine, data source, and operations documentation migrated from fluxmq-rs-doc and maintained here as version 1.0.",
    "searchPlaceholder": "Browse FluxMQ docs, rules and APIs",
    "sidebarLabel": "FluxMQ documentation navigation",
    ...
    "versions": [
      {
        ...
        "status": "latest",
        "date": "FluxMQ 1.0",
        "note": "Current website documentation version, migrated from fluxmq-rs-doc and restyled for the website docs system.",
        "command": "FLUXMQ_CONFIG_FILE=config.toml cargo run -p fluxmqd"
      }
    ],
    "groups": [
    ...
    "documents": {
      ...
      "guide/data-management": {
        ...
        "blocks": [
          ...
          {
            "type": "image",
            "alt": "FluxMQ 3.0 Data Management and dashboard screenshot",
            "src": "/fluxmq-docs/img/screenshots/dashboard.png"
          },
          {
            "type": "heading",
      ...
      "guide/datasources/object-search-loki": {
        ...
        "summary": "FluxMQ 3.0 can write rule-matched messages to S3-compatible object storage, Elasticsearch, OpenSearch, and Grafana Loki. These data sources are useful for archiving, search, and log streams.",
        "sourcePath": "guide/datasources/object-search-loki.md",
        "headings": [
          {
            "id": "console-entry",
        ...
        "blocks": [
          {
            "type": "paragraph",
            "text": "FluxMQ 3.0 can write rule-matched messages to S3-compatible object storage, Elasticsearch, OpenSearch, and Grafana Loki. These data sources are useful for archiving, search, and log streams."
          },
          {
            "type": "image",
            "alt": "FluxMQ 3.0 data source management screenshot",
            "src": "/fluxmq-docs/img/screenshots/datasources.png"
          },
          {
            "type": "heading",
      ...
      "guide/datasources/overview": {
        ...
        "summary": "Data sources are FluxMQ 3.0's unified abstraction for connecting to external systems. SQL authentication, HTTP webhooks, rule actions, offline-message workflows, and command pipelines all reuse data-source configuration.",
        "sourcePath": "guide/datasources/overview.md",
        "headings": [
          {
        ...
        "blocks": [
          {
            "type": "paragraph",
            "text": "Data sources are FluxMQ 3.0's unified abstraction for connecting to external systems. SQL authentication, HTTP webhooks, rule actions, offline-message workflows, and command pipelines all reuse data-source configuration."
          },
          {
            "type": "image",
            "alt": "FluxMQ 3.0 data sources page screenshot",
            "src": "/fluxmq-docs/img/screenshots/datasources.png"
          },
          {
            "type": "heading",
          ...
          },
          {
            ...
            "rows": [
              ...
              [
                "`source`",
                "FluxMQ rule source key, such as `POSTGRESQL`, `WEBHOOK`, `REDIS`, `KAFKA`, or `LOG`."
              ],
              [
                "`source_type`",
          ...
          {
            "type": "image",
            "alt": "FluxMQ 3.0 data source configuration screenshot",
            "src": "/fluxmq-docs/img/screenshots/datasources.png"
          },
          {
            "type": "paragraph",
      ...
      "guide/rule-engine/reliability-outbox": {
        ...
        "blocks": [
          ...
          {
            "type": "image",
            "alt": "FluxMQ 3.0 rule engine and outbox management screenshot",
            "src": "/fluxmq-docs/img/screenshots/rules.png"
          },
          {
            "type": "heading",
      ...
      "index": {
        "id": "index",
        "title": "FluxMQ 3.0 Documentation",
        "summary": "Product overview, deployment guides, console feature manuals, API references, operations notes, and demo assets for FluxMQ 3.0.",
        "sourcePath": "index.mdx",
        "headings": [
          {
            "id": "fluxmq-30-documentation",
            "level": 1,
            "text": "FluxMQ 3.0 Documentation"
          },
          {
            "id": "quick-links",
            "level": 2,
        ...
        "blocks": [
          {
            "type": "paragraph",
            "text": "Product overview, deployment guides, console feature manuals, API references, operations notes, and demo assets for FluxMQ 3.0."
          },
          {
            "type": "paragraph",
      ...
      "operations/storage": {
        ...
        "blocks": [
          {
            "type": "paragraph",
            "text": "FluxMQ 3.0 uses local RocksDB as the broker state machine. Single-node mode reads and writes local RocksDB directly. Cluster mode replicates metadata and management configuration through Storage Raft, while shard replicas carry larger keyspaces such as retained messages, sessions, and delayed messages."
          },
          {
            "type": "image",
            "alt": "FluxMQ 3.0 Storage Raft and storage overview screenshot",
            "src": "/fluxmq-docs/img/screenshots/dashboard.png"
          },
          {
            "type": "heading",
      ...
      "product/introduction": {
        ...
        "summary": "An integrated MQTT broker for device access, message governance, and data flow. FluxMQ includes a management console, authentication and ACL, rule engine, data sources, clustering, and observability.",
        "sourcePath": "product/introduction.mdx",
        "headings": [
          {
            "id": "fluxmq-30",
        ...
        "blocks": [
          ...
          {
            "type": "paragraph",
            "text": "An integrated MQTT broker for device access, message governance, and data flow. FluxMQ includes a management console, authentication and ACL, rule engine, data sources, clustering, and observability."
          },
          {
            "type": "paragraph",
            "text": "Quick Start"
          ...
          {
            "type": "image",
            "alt": "FluxMQ 3.0 layered architecture",
            "src": "/fluxmq-docs/img/architecture/fluxmq-3-architecture.svg"
          },
          {
            "type": "heading",
          ...
          {
            "type": "paragraph",
            "text": "`apps/fluxmqd` starts the process and coordinates `crates/mqtt`, `crates/broker`, and listener lifecycles."
          },
          {
            "type": "heading",
            "id": "management-and-security",
      ...
      "product/license": {
        ...
        "summary": "FluxMQ 3.0 has two license concepts: the open-source repository license and the runtime product license.",
        "sourcePath": "product/license.md",
        "headings": [
          {
        ...
        "blocks": [
          {
            "type": "paragraph",
            "text": "FluxMQ 3.0 has two license concepts: the open-source repository license and the runtime product license."
          },
          {
            "type": "image",
            "alt": "FluxMQ 3.0 dashboard license panel screenshot",
            "src": "/fluxmq-docs/img/screenshots/dashboard.png"
          },
          {
            "type": "heading",
          ...
          {
            "type": "paragraph",
            "text": "If no valid license is found, FluxMQ falls back to the community quota."
          },
          {
            "type": "table",
            "headers": [
